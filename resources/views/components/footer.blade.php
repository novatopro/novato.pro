<!-- Footer -->
<footer class="bg-body-tertiary mt-4 pt-5">
    <div class="container">
        <!-- Row START -->
        <div class="row g-4">
            ...
            <div class="col-lg-3">
                ...
                <p class="my-3 text-muted">Soporte.</p>
                <p class="mb-2"><a href="https://wa.me/573135583327" target="_blank"
                        class="text-muted text-primary-hover"><i class="bi bi-telephone me-2"></i>+57 3135583327</a> </p>
                <p class="mb-0"><a href="mailto:admin@novato.pro" class="text-muted text-primary-hover"><i
                            class="bi bi-envelope me-2"></i>admin@novato.pro</a></p>
            </div>
            <!-- Widget 1 END -->
                ...
                <div class="row g-4">
                    ...
                    <div class="col-6 col-md-3">
                        ...
                        <ul class="nav flex-column text-primary-hover">
                            ...
                            @endauth
                            <li class="nav-item"><a class="nav-link text-muted"
                                    href="{{ route('policy.show') }}">{{ __('Privacy policy') }}</a></li>
                            <li class="nav-item"><a class="nav-link text-muted"
                                    href="{{ route('terms.show') }}">{{ __('Terms and conditions') }}</a>
                            </li>
                    ...
                    <div class="nav mt-2 mt-lg-0">
                        <ul class="list-inline text-primary-hover mx-auto mb-0">
                            <li class="list-inline-item me-0"><a class="nav-link py-1 text-muted"
                                    href="{{ route('policy.show') }}">{{ __('Privacy policy') }}</a></li>
                            <li class="list-inline-item me-0"><a class="nav-link py-1 text-muted"
                                    href="{{ route('terms.show') }}">{{ __('Terms and conditions') }}</a></li>
